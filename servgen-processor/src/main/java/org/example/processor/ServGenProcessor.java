...
@SupportedAnnotationTypes("io.servgen.annotation.ServGen")
@SupportedSourceVersion(SourceVersion.RELEASE_21)
public class ServGenProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        for (Element element : roundEnv.getElementsAnnotatedWith(ServGen.class)) {
            ...
            ServGen annotation = element.getAnnotation(ServGen.class);
